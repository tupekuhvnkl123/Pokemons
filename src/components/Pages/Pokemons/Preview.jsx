...
const Preview = () => {
  return (
    ...
    >
      <div className="h-full w-full bg-primary_color bg-opacity-70 flex items-center justify-center px-[5%] gap-x-[10%] phone:flex-col phone:gap-y-20">
        <img
          className="w-[45%] object-cover object-center phone:w-[90%]"
          src={logoImage}
          alt="Logo"
        />
        <p className="w-[45%] text-center text-secondary_color font-bold xl:text-[clamp(10px,1.5vw,16px)] phone:!text-[16px] phone:w-[90%] ">
